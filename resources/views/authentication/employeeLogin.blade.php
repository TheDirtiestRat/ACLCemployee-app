...
<body class="text-center">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="{{ url('loginEmployee') }}" method="POST">
            ...
            <img class="mb-2" src="{{ asset('storage/images/aclc.png') }}" alt width="70">
            <h1 class="mb-3 fw-normal">@include('components.systemTitle')</h1>

            {{-- alert --}}
            @include('components.alert')

            <div class="form-floating mb-3">
                <input type="number" class="form-control text-dark" id="floatingInput" name="employee_id"
                    placeholder="000000">
                <label for="floatingInput text-dark">Enter Employee ID: 0########</label>
            </div>
