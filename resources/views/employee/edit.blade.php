...
@section('content')
    ...
    <form action="{{ route('employee.update', $employe_identification['employee_id']) }}" method="post" class="needs-validations" enctype="multipart/form-data" novalidat>
        {{-- for validation --}}
        @csrf
        @method('PUT')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Do you wanna remove <strong>{{ $employe_identification['firstname'] }} {{ $employe_identification['middlename'] }} {{ $employe_identification['surname'] }}</strong></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>

                    {{-- data deletion form --}}
                    <form action="{{ route('employee.destroy', $employe_identification['employee_id']) }}" method="post">
                        @csrf
                        @method('DELETE')
